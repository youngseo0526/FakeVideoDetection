...
if __name__=="__main__":
    ...
    parser.add_argument('--inversion', default="/data/yskim/pix2pix-zero/output/test_cat/inversion/cat_6.pt")
    parser.add_argument('--prompt', type=str, default="/data/yskim/pix2pix-zero/output/test_cat/prompt/cat_6.txt")
